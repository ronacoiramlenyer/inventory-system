...
export default function LabStockCards() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Two categories side by side on a wide screen. Each block is only
          three columns deep, so stacked down one column they left most of
          the page empty and pushed the later categories off the bottom.
          items-start keeps a short block short instead of stretching it to
          match whatever sits beside it. Two at most: a third column leaves
          the item names too narrow to read, and that is the column that
          matters. */}
          ...
          <table className="w-full text-sm table-fixed">
            <thead className="bg-slate-50 text-slate-500">
              <tr>
                ...
                <th className="px-4 py-2 text-left font-medium w-24">Unit</th>
